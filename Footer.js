      ...
      <section className="">
        ...
        >
          ...
          <h4 id="FooterDesc" className="text-center py-4">
            Empowering Minds for a Happier, Healthier Future.
          </h4>
        ...
        <section
          className="d-flex align-items-center justify-content-evenly pt-5"
          id="MainFooter"
        >
          <div>
          ...
          <div>
            ...
            <h5>
              <a href="#">
                <a href="#" class="fa fa-facebook pe-2"></a>Facebook
              </a>
            </h5>
            <h5>
              <a href="#">
                <a href="#" class="fa fa-instagram pe-2"></a>Instagram
              </a>
            </h5>
            <h5>
              <a href="#">
                <a href="#" class="fa fa-twitter pe-2"></a>Twitter
              </a>
            </h5>
          </div>
